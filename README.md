...
1.  **Open in Unity**: Use Unity 2022.3 LTS or newer.
2.  **Import Assets**: Ensure all sprites and videos are placed in their respective folders.
3.  **Explore Levels**: Check the `Scenes/Levels` folder for individual module challenges.
